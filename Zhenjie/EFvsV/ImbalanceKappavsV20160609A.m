...
for i=1:length(ImglistMajority)
    [~,~,~,VsortS1,~,~,~,EFS1]=EOS_Online( ImglistMajority{i},'ROI1',[157,25,390,490],...
     'ROI2',[157,150,390,380],'TailRange',[90,410],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
    'Fudge',2.5,'BGSubtraction',0,'IfFitExpTail',1,'Nsat',390,'ShowPlot',0,'CutOff',inf,'IfHalf',0);
...
%% Switch to Minority
load('Data/2016-06-09-minorityA.mat');
...
for i=1:length(ImglistMinority)
    [~,~,~,VsortS2,~,~,~,EFS2]=EOS_Online(ImglistMinority{i},'ROI1',[157,25,390,490],...
     'ROI2',[157,200,390,320],'TailRange',[90,410],'ShowOutline',0,'KappaMode',2,'PolyOrder',10,'VrangeFactor',5,'IfHalf',0,'kmax',0.9,'kmin',0.15,...
    'Fudge',2.5,'BGSubtraction',0,'IfFitExpTail',1,'Nsat',390,'ShowPlot',0,'CutOff',inf,'IfHalf',0);
